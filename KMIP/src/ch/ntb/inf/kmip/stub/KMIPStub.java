...
public class KMIPStub implements KMIPStubInterface {
    ...
    public KMIPStub() {
        ...
        try {
            ...
            // Added to allow loading config from outside JAR
            if(System.getenv("KMIP4J_CONFIG") != null)
                xmlPath = System.getenv("KMIP4J_CONFIG");
            else
            {
                xmlPath =  this.getClass().getResource("config/").getPath();
